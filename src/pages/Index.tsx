...
const Index = () => {
  ...
  return (
    <div>
      {/* ── HERO ── */}
      <section className="relative overflow-hidden min-h-[68svh] sm:min-h-[460px] lg:min-h-[520px] bg-stone-100">
        {/* Mobile photo */}
        <OptimizedImage
          src={HERO_IMG_MOBILE}
          alt="Жінка на йога-килимку перед дзеркалом"
          className="sm:hidden absolute inset-0 h-full w-full object-cover object-[50%_20%]"
          loading="eager"
          fetchPriority="high"
          sizes="100vw"
          quality={85}
        ...
        <OptimizedImage
          src={HERO_IMG}
          alt="Жінка на йога-килимку перед дзеркалом"
          className="hidden sm:block absolute inset-0 h-full w-full object-cover object-[60%_30%]"
          loading="eager"
          fetchPriority="high"
          sizes="100vw"
          quality={85}
